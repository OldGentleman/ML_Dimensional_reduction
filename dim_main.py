...
sets = [(*read_set('iris.zip'), [2]), (*read_set('d2 - fashion_mnist.zip'), [2]), (*read_set('d8 - mushrooms.zip'), [2]), (*read_set('d9 - mnist_sighns.zip'), [2]), (*read_set('d10 - student_alchohol.zip'), [2]),
        (*read_set('d11 - mnist_sign_language.zip'), [2]), (*read_set('d13 - fer2013_I.zip'), [2]), (*read_set('d16 - restaurant.zip'), [2]), (*read_set('d22 - student_exams.zip'), [2]), (*read_set('IBM.zip'), [2]), (*read_set('wine.zip'), [2])]
sets = [(*read_set('d12 - human.zip'), [2])]
