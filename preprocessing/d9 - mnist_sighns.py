...
zf = zipfile.ZipFile('../data/raw_data/d9 - mnist_sighns.zip')
...
compression=dict(
    method='zip', archive_name='d9 - mnist_sighns.csv')

data_features_scaled.to_csv(
    '../data/preprocessed_data/d9 - mnist_sighns.zip', index=False, compression=compression)